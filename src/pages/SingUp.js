      ...
      <div>
        <div className="bg-white">
          <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            {/* INICIO FORM */}
            <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-8 lg:py-12 xl:col-span-7">
              <div className="max-w-xl lg:max-w-full">
                ...
                >
                  {({
                    ...
                    <form action="#" className="grid grid-cols-9 gap-5 ">
